...
BOOST_DOWNLOAD_LINK="https://sourceforge.net/projects/boost/files/boost/$BOOST_VER1.$BOOST_VER2.$BOOST_VER3/boost_${BOOST_VER1}_${BOOST_VER2}_${BOOST_VER3}.tar.bz2"
